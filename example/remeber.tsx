  ...
  return (
    ...
    >
      <group ref={groupRef}>
        {fragments.map((frag, i) => (
          ...
          >
            <meshStandardMaterial
              color={frag.isOuter ? "#0f0f16" : "#1a1a2e"}
        ...
        <pointLight position={[0, 0, 0]} intensity={0.4} distance={0} decay={2} color="#ffffff" />
...
const Scene = ({ scrollRef }: { scrollRef: React.MutableRefObject<number> }) => {
  return (
    <>
      ...
      <pointLight position={[0, 0, 3]} intensity={0.06} color="#4a90d9" />
